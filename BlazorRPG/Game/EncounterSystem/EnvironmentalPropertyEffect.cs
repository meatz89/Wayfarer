public class EnvironmentalPropertyEffect
{
    ...
    public override string ToString()
    {
        ...
        string effectDesc = $"{activationProperties}: {EffectType.ToString()}";
        return effectDesc;
    }
    ...
    public int GetMomentumModifierForTag(StrategicTag tag)
    {
    ...
    public int GetPressureModifierForTag(StrategicTag tag)
    {
        bool propertiesMatch = IsActive(tag);
