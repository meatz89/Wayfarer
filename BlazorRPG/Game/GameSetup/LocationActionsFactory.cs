...
public static class LocationActionsFactory
{
    ...
    )
    {
        ...
        switch (locationType)
        {
            ...
            case LocationTypes.Social:
                ...
                {
                    actions.AddRange(GetActivityTypeActionsForSocial(locationType, activityType));
                }
                break;
    ...
    private static List<BasicAction> GetActivityTypeActionsForSocial(LocationTypes locationType, ActivityTypes activityType)
    {
        List<BasicAction> actions = new List<BasicAction>();
        switch (activityType)
        {
            ...
            case ShelterStates.Bad:
                actions.Add(
                    AddAction(action => action
                        ...
                        .WithDescription("Rest in Bad Shelter")
                        .AddTimeWindow(TimeWindows.Evening)
                        .AddTimeWindow(TimeWindows.Night)
                        .ExpendsFood(1)
                    )
