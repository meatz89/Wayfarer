...
{
    public static Encounter TavernServeDrinks => new EncounterBuilder()
        ...
        .InCharacterRole(CharacterRoleTypes.WorkFor)
        ...
        .AddStage(stage => stage
            ...
            .AddChoice(choice => choice
                ...
                .WithEncounter("Grab several mugs at once, aiming to serve multiple customers quickly.")
            ...
            .AddChoice(choice => choice
                ...
                .WithEncounter("Take a moment to plan your route and prioritize orders.")
            ...
            .AddChoice(choice => choice
                ...
                .WithEncounter("Coordinate with colleagues to establish serving zones.")
                .ExpendsEnergy(EnergyTypes.Physical, 1)
        ...
        .AddStage(stage => stage
            ...
            .AddChoice(choice => choice
                ...
                .WithChoiceType(ChoiceTypes.Aggressive)
                .WithEncounter("Make a rapid move to stabilize the drinks.")
                .WithAdvantageChange(-1)
                .WithMomentumChange(2)
            )
            ...
            .AddChoice(choice => choice
                ...
                .WithChoiceType(ChoiceTypes.Careful)
                .WithEncounter("Carefully adjust your grip and stance.")
            ...
            .AddChoice(choice => choice
                ...
                .WithChoiceType(ChoiceTypes.Tactical)
                .WithEncounter("Shift through nearby patrons to regain balance.")
                .WithAdvantageChange(2)
            ...
            .AddChoice(choice => choice
                ...
                .WithChoiceType(ChoiceTypes.Tactical)
                .WithEncounter("Politely but firmly request more room to work.")
                .WhenTensionAbove(5)
                .WithTensionChange(-2)
                .WithConnectionChange(1)
            ))
