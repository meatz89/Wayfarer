namespace BlazorRPG.GameState
{
    public class TradeManager
    {
        public List<TradeItem> GetAvailableItems(GameWorld gameWorld)
        {
        ...
        public bool CanBuyItem(GameWorld gameWorld, TradeItem item)
        {
        ...
        public void BuyItem(GameWorld gameWorld, TradeItem item)
        {
        ...
        public void SellItem(GameWorld gameWorld, TradeItem item)
        {
