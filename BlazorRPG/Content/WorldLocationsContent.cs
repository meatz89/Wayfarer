public class WorldLocationsContent
{
    public static Location DeepForest => new LocationBuilder()
         ...
         .AddLocationSpot(spot => spot
             ...
             .AddAction(ActionNames.ClimbTree)
             .AddAction(ActionNames.SurveyArea))
         .AddLocationSpot(spot => spot
             .WithName("Dense Underbrush")
             .WithDescription("Thick vegetation making progress difficult but providing good cover.")
             .WithIllumination(Illumination.Shadowy)
             .WithAtmosphere(Atmosphere.Rough)
             .WithPopulation(Population.Quiet)
             .WithPhysical(Physical.Confined)
             .AddAction(ActionNames.MoveStealthily)
             .AddAction(ActionNames.ForceThrough)
             .AddAction(ActionNames.FindNaturalPath))
         .AddLocationSpot(spot => spot
