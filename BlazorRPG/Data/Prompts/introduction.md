...
- RESOURCE SCARCITY: Multiple parties competing for limited resources or opportunities

The selected conflict should:
- Arise NATURALLY from the location and context (never force a conflict type)
- Create meaningful STAKES for success or failure
- Offer multiple VIABLE approaches to resolution
- Introduce TENSION appropriate to the encounter type
...
7. Ensure characters have understandable motivations where neither is clearly "right"
8. Use weather, lighting, or architecture to enhance the mood of confrontation
9. The player's potential choices should involve complicated moral considerations
