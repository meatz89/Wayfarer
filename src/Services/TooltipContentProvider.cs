...
public static class TooltipContentProvider
{
    public static readonly Dictionary<string, string> Definitions = new()
    {
        ...
        ["Momentum"] = "Progress toward conversation situations. Reach 8 (Basic), 12 (Priority), or 16 (Immediate) to complete delivery.",
        ...
        // Tokens
        ["Trust"] = "Personal connection token. Earned from Basic situations. Used for personal favors.",
        ["Status"] = "Social standing token. Earned from Immediate situations. Used for exclusive access.",
