...
/// Uses hex coordinates for spatial positioning - venue derived from hex radius grouping.
...
public class LocationDTO
{
    ...
    public string VenueId { get; set; }  // HIGHLANDER: References Venue by Name (natural key)
