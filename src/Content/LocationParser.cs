...
public static class LocationParser
{
    ...
    public static Location ConvertDTOToLocation(LocationDTO dto, GameWorld gameWorld)
    {
        ...
        // Venue resolution via hex spatial system (not entity instance ID)
        // CORRECT PATTERN: Venue derived from hex position (locations within radius belong to venue)
        // WRONG PATTERN: VenueId entity instance ID lookup
        // Venue assignment happens during hex grid synchronization via HexSynchronizationService
