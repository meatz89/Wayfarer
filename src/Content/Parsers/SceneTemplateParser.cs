...
public class SceneTemplateParser
{
    ...
    public SceneTemplate ParseSceneTemplate(SceneTemplateDTO dto)
    {
        ...
        // CATEGORICAL PARSING: Extract concrete IDs from PlacementFilter if present
        // This enables catalog to generate context-aware SituationTemplates with RequiredNpcId/RequiredLocationId
        // Templates generated by catalog will have proper context for scene activation checks
        string npcId = dto.PlacementFilter?.NpcId;
        string locationId = dto.PlacementFilter?.LocationId;

        Console.WriteLine($"[SceneGeneration] Categorical context: Tier={dto.Tier}, MainStorySequence={dto.MainStorySequence}, NpcId={npcId}, LocationId={locationId}");
