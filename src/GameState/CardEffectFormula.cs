...
public class CardEffectFormula
{
    ...
    /// </summary>
    public int CalculateEffect(ConversationSession session)
    {
        switch (FormulaType)
        {
    ...
    private int CalculateScaling(ConversationSession session)
    {
    ...
    private int CalculateConditional(ConversationSession session)
    {
    ...
    /// </summary>
    public bool CanExecuteTrade(ConversationSession session)
    {
    ...
    /// </summary>
    public bool ExecuteTrade(ConversationSession session)
    {
