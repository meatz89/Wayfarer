...
public class Item
{
    ...
    // Token generation modifiers for equipment (basis points where 10000 = 1.0x)
    public Dictionary<ConnectionType, int> TokenGenerationModifiers { get; set; } = new Dictionary<ConnectionType, int>();
