...
public class DebugLogger
{
    ...
    public void LogNavigation(string fromScreen, string toScreen, string reason = null)
    {
        ...
        var message = $"NAV: {fromScreen} → {toScreen}";
    ...
    public void LogTimeChange(string fromTime, string toTime, int hoursAdvanced)
    {
        ...
        var message = $"TIME: {fromTime} → {toTime} | Advanced {hoursAdvanced} hours";
    ...
    public void LogPolling(string component, string state)
    {
        ...
        var message = $"POLL: {component} | {state}";
    ...
    public void LogError(string component, string error, Exception ex = null)
    {
        ...
        var message = $"ERROR: {component} | {error}";
        if (ex != null)
    ...
    public void LogWarning(string component, string warning)
    {
        ...
        var message = $"WARN: {component} | {warning}";
    ...
    {
        var query = _logs.Where(l => l.Timestamp >= since);
    ...
    public string GenerateStateReport(GameWorld gameWorld)
    {
        ...
        report.Add($"  Hours: {gameWorld.TimeManager.CurrentTimeHours}");
        ...
        {
            var allNpcs = gameWorld.WorldState.NPCs;
    ...
    {
        // TODO: Check configuration or debug flag
        return true;
    }
}
