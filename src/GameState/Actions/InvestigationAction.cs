...
{
    /// <summary>
    /// Investigation action allows players to spend 1 attention and 10 minutes to gain familiarity with a location.
    ...
    public class InvestigationAction
    {
        ...
        /// <summary>
        /// Time required for investigation in minutes (always 10)
        /// </summary>
