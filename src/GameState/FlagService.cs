...
public class FlagService
{
    ...
    public void RestoreState(FlagServiceState state)
    {
        ...
        {
            foreach (KeyValuePair<string, bool> kvp in state.BooleanFlags)
            {
        ...
        {
            foreach (KeyValuePair<string, int> kvp in state.CounterFlags)
            {
        ...
        {
            foreach (KeyValuePair<string, DateTime> kvp in state.TimestampFlags)
            {
