...
public class PhysicalCard
{
    ...
    public CardType CardType { get; init; } = CardType.Physical;
    ...
    /// <summary>
    /// Get Position generation for Foundation cards (parallel to Attention generation)
    /// Foundation cards (Depth 1-2) generate +1 Position
    /// </summary>
    public int GetPositionGeneration()
    {
        return Depth <= 2 ? 1 : 0;
    }
