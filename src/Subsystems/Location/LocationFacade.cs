...
public class LocationFacade
{
    ...
    private readonly LocationChallengeBuilder _challengeBuilder;
    ...
    public LocationFacade(
        ...
        LocationChallengeBuilder challengeBuilder)
    {
        ...
        _challengeBuilder = challengeBuilder ?? throw new ArgumentNullException(nameof(challengeBuilder));
    }
    ...
    public LocationContentViewModel GetLocationContentViewModel()
    {
        ...
        ChallengeBuildResult mentalResult = _challengeBuilder.BuildMentalChallenges(spot);
        ...
        ChallengeBuildResult physicalResult = _challengeBuilder.BuildPhysicalChallenges(spot);
