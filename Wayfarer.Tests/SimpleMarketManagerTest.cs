...
namespace Wayfarer.Tests
{
    public class SimpleMarketManagerTest
    {
        ...
        public void MarketManager_ItemRepository_Returns_Items()
        {
            ...
            Type marketType = marketManager.GetType();
            System.Reflection.FieldInfo? itemRepoField = marketType.GetField("_itemRepository", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            ...
            {
                System.Reflection.MethodInfo? getDynamicPricingMethod = marketType.GetMethod("GetDynamicPricing", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
                dynamic pricing = getDynamicPricingMethod.Invoke(marketManager, new object[] { "town_square", baseItem.Id });

                if (pricing.IsAvailable)
                {
                    System.Reflection.MethodInfo? createItemMethod = marketType.GetMethod("CreateItemWithLocationPricing", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
