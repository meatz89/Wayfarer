...
namespace Wayfarer.Tests
{
    ...
    public class EnumParserTests
    {
        ...
        {
            // Arrange & Act & Assert
            Assert.True(EnumParser.TryParse<ItemCategory>("Trade_Goods", out var category));
            Assert.Equal(ItemCategory.Trade_Goods, category);
            
            Assert.True(EnumParser.TryParse<ItemCategory>("TRADE_GOODS", out var category2, ignoreCase: true));
        ...
        {
            // Arrange & Act & Assert
            Assert.True(EnumParser.TryParse<ItemCategory>("Trade Goods", out var category));
            Assert.Equal(ItemCategory.Trade_Goods, category);
        }
        ...
        {
            // Arrange
            var values = new[] { "Trade_Goods", "Tools", "Food" };
            
            // Act
            var result = EnumParser.ParseList<ItemCategory>(values, "categories");
        ...
        {
            // Arrange
            var values = new[] { "Trade_Goods", "InvalidCategory", "Tools" };
        ...
        {
            // Arrange
            var values = new[] { "Trade_Goods", "InvalidCategory", "Tools", "", null };
            
            // Act
            var result = EnumParser.TryParseList<ItemCategory>(values);
