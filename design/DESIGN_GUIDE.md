...
- **[arc42/08_crosscutting_concepts.md](../architecture/08_crosscutting_concepts.md)** - Catalogue pattern, entity initialization, parse-time translation
- **[arc42/12_glossary.md](../architecture/12_glossary.md)** - Technical definitions (PathType, ChallengeType, NPCDemeanor, Quality)
